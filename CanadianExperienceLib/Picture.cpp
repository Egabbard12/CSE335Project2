...
void Picture::Save(const wxString& filename)
{
    ...
    mMachineAdapterLeft->SaveMachineData(L"LeftMachine",root);
    mMachineAdapterRight->SaveMachineData(L"RightMachine",root);
...
void Picture::Load(const wxString& filename)
{
    ...
    mMachineAdapterLeft->LoadMachineData(L"LeftMachine",root);
    mMachineAdapterRight->LoadMachineData(L"RightMachine", root);
