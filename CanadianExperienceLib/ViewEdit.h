...
private:
    ...
    void OnEditLeftMachineNum(wxCommandEvent& event);
    void OnEditRightMachineNum(wxCommandEvent& event);
    void OnSetMachineFrameRight(wxCommandEvent& event);
    void OnSetMachineFrameLeft(wxCommandEvent& event);
